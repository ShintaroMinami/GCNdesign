...
import numpy as np
import torch
from .hypara2021 import HyperParam, InputSource
from .models import GCNdesign2021
...
class Predictor():
    def __init__(self, device: str=None, param: str=None, hypara=None):
        ...
        model_params = torch.load(self.param, map_location=torch.device(self.device))
        self.model = GCNdesign2021(self.hypara)
